from numpy import array, abs, arange, dot, int8, int32, floor, fromfunction, hypot, ones, prod, random, indices, newaxis, poly1d
import Image
class PerlinNoise(object):
	...
	def getImage(self, scale=32.0):
		return Image.frombuffer('L', self.size[:2], self.getData(scale)[ : self.size[0]*self.size[1]], 'raw', 'L', 0, 1)
